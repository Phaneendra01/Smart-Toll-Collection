...
const char* password = "pannu2003hsp";
//======================================== 

//======================================== Replace with your "Deployment ID" and Folder Name.
String myDeploymentID = "AKfycbz21ByhC8mo9b5W_bcIIeu9QMsib9U9jzH4omgSosccuA5IAE8Nlm-FfDfPBWypsgB_";
...
void loop() {
  // Check if IO13 pin is high
  if (digitalRead(13) == HIGH) {
    // Immediately capture and send photos when IO13 pin is high
    SendCapturedPhotos();

    // Wait for IO13 pin to go low again
