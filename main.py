...
download_directory = r"C:\Users\phane\Documents\NIE Final year project\Database\Vehicle Images"
...
try: 
            ...
            def image_operations(directory):
                ...
                if not image_files:
                    ...
                    for image_path in image_files:
                        ...
                        enlarge_image(path1, path1, 2.5)
                        increase_contrast(path1,path1, 2.5)

            # Replace 'your_directory_path' with the path to the directory containing the images
            vehicleimage_directory_path = r"C:\Users\phane\Documents\NIE Final year project\Database\Vehicle Images"
            ...
            input_directory = "C:/Users/phane/Documents/NIE Final year project/Database/Vehicle Images/"
            output_directory = "C:/Users/phane/Documents/NIE Final year project/Database/Number Plate Images/"
            ...
            def convert_to_pdf(excel_filename, pdf_filename, image_filename):
                ...
                pdf_canvas.drawString(250, 750, "Amount Deducted")  # Adjusted X-coordinate for "Amount Deducted"
                ...
                # Draw image
                pdf_canvas.drawImage(image_filename, 100, y_coordinate - image_height, width=image_width, height=image_height)
            ...
            default_path = r"C:\Users\phane\Documents\NIE Final year project\Database\Bills"
            image_filename = r"C:\Users\phane\Documents\NIE Final year project\Resources\upi.png"  # Provide the path to your image file here
            ...
            directory_path = r"C:\Users\phane\Documents\NIE Final year project\Database\Vehicle Images"
            ...
            attachment_path = rf"C:\Users\phane\Documents\NIE Final year project\Database\Bills\{result2}.pdf"

            try:
                  send_email(sender_email, sender_password, recipient_email, subject, body, attachment_path)
            except Exception as e:
                  print("The recipient email is not registerd. ")
